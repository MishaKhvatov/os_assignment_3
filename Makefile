...
# Test files
TEST_BINS := alarm_test display_test start_test change_test
...
start_test: $(TEST_DIR)/start_test.c $(OBJ_DIR)/src/alarm.o $(OBJ_DIR)/src/display.o $(OBJ_DIR)/src/console.o
	$(CC) $(CFLAGS) $^ -o $@ $(LDFLAGS)

# Compile and link change_test
change_test: $(TEST_DIR)/change_test.c $(OBJ_DIR)/src/alarm.o $(OBJ_DIR)/src/display.o $(OBJ_DIR)/src/console.o
	$(CC) $(CFLAGS) $^ -o $@ $(LDFLAGS)
